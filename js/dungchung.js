...
function signUp(form) {
    ...
    var confirmPass = form.confirm.value;
    var newUser = new User(username, pass, ho, ten, address, phone, email);

    // Kiểm tra tên đăng nhập không bắt đầu bằng chữ số
    if (/^\d/.test(username)) {
        alert('Tên đăng nhập không hợp lệ !');
        return false;
    }

    // Kiểm tra số điện thoại chỉ bao gồm chữ số và có từ 10 đến 15 số
    ...
    // Đảm bảo mật khẩu bao gồm ít nhất 6 ký tự
    if (pass.length < 6) {
        alert('Mật khẩu không hợp lệ !');
        return false;
    }

    // Đảm bảo mật khẩu bao gồm ít nhất một chữ cái in hoa, chữ số và ký tự đặc biệt
    var passwordPattern = /^(?=.*[A-Z])(?=.*[0-9])(?=.*[@!#]).{6,}$/;
    if (!passwordPattern.test(pass)) {
        alert('Mật khẩu phải bao gồm ít nhất một chữ cái in hoa, một chữ số và ký tự đặc biệt (@, !, #...)');
        return false;
    }
            ...
            <div class="tools-member">
                <div class="member">
                    ...
                    <div class="menuMember hide">
                        <a href="nguoidung.html">Quản lý tài khoản</a>
                ...
                <div id="signup">
                    ...
                    <form onsubmit="return signUp(this);">
                        ...
                        <div class="field-wrap">
                            ...
                            <input name="confirm" type="password" required autocomplete="off" />
                        </div> <!-- /confirm -->
    ...
    <div class="plc">
        <section>
            <ul class="flexContain">
                ...
                <li>Thanh toán bằng nhiều phương thức </li>
                <li>Trải nghiệm sản phẩm tại nhà</li>
                <li>Lỗi 1 đổi 1 trong vòng 30 ngày</li>
                <li>Hỗ trợ 24/7
                    <br>Hotline:
                    <a href="tel:023 542 8726" style="color: #288ad6;">023 542 8726</a>
                </li>
            </ul>
        </section>
    </div>`);
